...
<div class="btn-group">
  ...
  <a class="dropdown-item" href="home.php"><h5>All media</h5></a>
    <a class="dropdown-item" href="filter/filter_available.php">Available media</a>
    <a class="dropdown-item" href="filter/filter_publisher.php">Show all publisher</a>
    <a class="dropdown-item" href="filter/filter_sortMedAsc.php">Sort media title asc</a>
    <a class="dropdown-item" href="filter/filter_sortMedDesc.php">Sort media title desc</a>
    <a class="dropdown-item" href="filter/filter_genreAsc.php">Sort genre asc</a>
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="#"><h5>Select type:</h5></a>
    <a class="dropdown-item" href="filter/filter_type_game.php">Game</a>
    <a class="dropdown-item" href="filter/filter_type_music.php">Music</a>
    <a class="dropdown-item" href="filter/filter_type_movie.php">Movie</a>
    <a class="dropdown-item" href="filter/filter_type_book.php">Book</a>
  </div>
</div>
